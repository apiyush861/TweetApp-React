        ...
        <>
            <div className={"d-flex h-100 justify-content-center align-items-center"}>
                <div style={{ width: "30%", maxWidth: 400 }}>
                    ...
                    <div>
                        <h2 style={{ fontFamily: "Barlow-Bold", marginBottom: 20 }}>Welcome to Tweet App</h2>
                    </div>
                    ...
                    <div>
                        ...
                        <a style={{ cursor: "pointer", color: "#1DA1F2" }} className="loginLink" onClick={onRegisterClick}>Register</a>
                    </div>
                </div>
            </div>
        </>
